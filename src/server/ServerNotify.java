...
public class ServerNotify extends Thread {
    ...
    private final String notify[] = {"Tham gia ngay Box Zalo tại trang chủ : cauberong.com để nhận nhiều phần quà từ Admin"};
    ...
    public void run() {
        while (!Maintenance.isRunning) {
            try {
                ...
                if (Util.canDoWithTime(this.lastNotifyTime, 10000)) {
