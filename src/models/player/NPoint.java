...
//        }
    ...
    public long calSucManhTiemNang(long tiemNang) {
        if (power < getPowerLimit()) {
            ...
            long tn1 = tiemNang;
            if (!this.player.isPet && this.player.itemTime.isTnDeTu || this.player.isPet && ((Pet) this.player).master.itemTime.isTnDeTu) {
                tiemNang += tn1 * 2;
            }
    ...
    public long calSubTNSM(long tiemNang) {
        if (this.player.zone.map.mapId >= 156 && this.player.zone.map.mapId <= 159 || this.player.zone.map.mapId == 184) {
            tiemNang /= 20;
        }
        if (power >= 40000000000L) {
            ...
            tiemNang -= ((long) tiemNang * 99.9f / 100);
        } else if (power >= 121000000000L) {
            tiemNang -= ((long) tiemNang * 99.9f / 100);
        }
        return tiemNang < 1 ? 1 : tiemNang;
    }
