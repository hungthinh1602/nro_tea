...
public class TDT_NM extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        ItemMap it = new ItemMap(this.zone, 433, 1, this.location.x, this.location.y, plKill.id);
        it.options.add(new ItemOption(50, Util.nextInt(12, 15)));
        it.options.add(new ItemOption(94, Util.nextInt(8, 10)));
        it.options.add(new ItemOption(93, new Random().nextInt(2) + 3));
        Service.gI().dropItemMap(this.zone, it);
    }
