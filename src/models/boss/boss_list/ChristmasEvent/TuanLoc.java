...
import models.boss.boss_list.LunarNewYearEvent.*;
...
public class TuanLoc extends Boss {
    ...
    public TuanLoc() throws Exception {
        super(TET_EVENT, BossID.TUAN_LOC - Util.nextInt(1000000), BossesData.TUAN_LOC);
    }
    ...
    public synchronized int injured(Player plAtt, long damage, boolean piercing, boolean isMobAttack) {
        if (!this.isDie()) {
            ...
            if (damage >= this.nPoint.hp) {
                ...
                Service.gI().chat(plAtt, "Đi thôi tuần lộc!");
