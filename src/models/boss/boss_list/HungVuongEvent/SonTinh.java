...
public class SonTinh extends Boss {
    ...
    public void afk() {
        if (playerReward.isPl() && !isReward && this.zone != null) {
            ...
            it.options.add(new Item.ItemOption(94, Util.nextInt(1, 8)));
            it.options.add(new Item.ItemOption(95, Util.nextInt(1, 8)));
            it.options.add(new Item.ItemOption(108, Util.nextInt(2, 10)));
            if (Util.isTrue(1, 15)) {
