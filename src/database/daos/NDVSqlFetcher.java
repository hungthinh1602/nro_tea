    ...
    public static Player login(MySession session, AntiLogin al) {
        ...
        try {
            ...
            if (rs.first()) {
                ...
                session.sotien = rs.getInt("sotien");
    ...
    private static Player loadPlayer(AlyraResultSet rs, boolean isOffline) throws Exception {
        ...
        try {
            ...
            try {
                ...
                player.inventory.gold = Long.parseLong(String.valueOf(ob.get("gold")));
                player.inventory.gem = Integer.parseInt(String.valueOf(ob.get("gem")));
                player.inventory.ruby = Integer.parseInt(String.valueOf(ob.get("ruby")));
                player.inventory.coupon = 0;
                player.inventory.event = 0;
                ob.clear();
            }
